...
<link rel="stylesheet" href="e_mypage_css/e_info.css" type="text/css" media="screen" />
<link rel="stylesheet" href="e_mypage_css/e_leftmenu.css" type="text/css" media="screen" />
<link rel="stylesheet" href="e_mypage_css/star.css" type="text/css" media="screen" />
	...
	<form action="" method="post">
		...
		<colgroup>
			...
			<tr>
				...
				<td>
					<input type="password" id="" name="" class="wid02">
				</td>
...
<div class="e_info_table2">
	...
	<table class="tb_st01">
		...
		<tr>
        	<td rowspan="5">
	            <img name="IMG1" id="IMG1" src="e_mypage_img/item_noimage.gif">
				<div class="filebutton">
					<span>사진업로드</span>
					<input type="file" name="fm_file1" onchange="readURL(this);" class="searchfile" title="파일 찾기" style="width:820px;">
				</div>
            </td>
        	<th scope="row">가입자 명</th>
            <td colspan="4">
            	<input type="text" id="fm_korname" name="fm_korname" class="wid02" value="">
            </td>
        </tr>
        <tr>
        	<th scope="row">회사명</th>
        ...
        <tr>
            ...
            <td>
            	<input type="text" id="fm_ceoname" name="fm_ceoname" class="wid" value="">
            </td>
            <th scope="row">사업자등록번호</th>
            <td colspan="2">
            	<input type="text" id="fm_comssn1" name="fm_comssn1" class="wid03" value="" maxlength="3">
                <span>-</span>
                <input type="text" id="fm_comssn2" name="fm_comssn2" class="wid03" maxlength="2" value="">
                <span>-</span>
                <input type="text" id="fm_comssn3" name="fm_comssn3" class="wid03" maxlength="5" value="">
             </td>
         </tr>
         <tr>
            ...
            <span>-</span>
            <input type="text" id="fm_tel2" name="fm_tel2" class="wid03" maxlength="4" value="">
            <span>-</span>
            <input type="text" id="fm_tel3" name="fm_tel3" class="wid03" maxlength="4" value="">
          </td>
       </tr>
       <tr>
          <th scope="row"><label for="fm_bizcontents">주요사업내용</label></th>
          <td colspan="4">
				<input type="text" id="fm_bizcontents" name="fm_bizcontents" class="wid" value="">
          </td>
        </tr>
        <tr>
       		<th scope="row"><label for="fm_managername">담당자명</label></th>
            <td>
            	<input type="text" id="fm_managername" name="fm_managername" class="wid07" value="">
            </td>
            ...
            <td colspan="3">
                ...
                <span>-</span>
                <input type="text" id="fm_phone2" name="fm_phone2" class="wid03" maxlength="4" value="">
                <span>-</span>
                <input type="text" id="fm_phone3" name="fm_phone3" class="wid03" maxlength="4" value="">
             </td>
          </tr>
          <tr>
          	<th>담당자 이메일</th>
            <td colspan="5">
                ...
                <span>@</span>
                <input type="text" id="fm_email12" name="fm_email12" class="wid04" value="" readonly="">
            ...
            <tr>
                ...
                <td colspan="5">
                <div class="mb10">
                	<input type="text" id="fm_zip" name="fm_zip" class="wid60" onclick="openDaumPostCode(); return false;" target="_blank" title="주소검색 새창" value="" readonly="">
                    <a href="javascript:void(0);" class="btn_add" onclick="openDaumPostCode(); return false;" target="_blank" title="주소검색 새창">우편번호찾기</a>
                </div>
                <div>
                	<input type="text" id="fm_address" name="fm_address" class="wid" value="">
                </div>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="5">
	                <div>
	                <span>http://</span>
	                <input type="text" id="fm_homepage" name="fm_homepage" class="wid06" value="">
	                </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
            	<td>
                	<input type="text" id="fm_foundyear" name="fm_foundyear" class="wid03" maxlength="4" value=""><label for="fm_foundyear"> 년</label>
                </td>
                <td>
                	<input type="text" id="fm_employnum" name="fm_employnum" class="wid03" value=""><label for="fm_employnum"> 명</label>
                </td>
                <td>
	                <select class="wid07" name="fm_stockchk" id="fm_stockchk">
                 ...
                 <td>
                 	<input type="text" id="fm_capitalmoney" name="fm_capitalmoney" class="wid05" value=""><label for="fm_capitalmoney"> 만원</label></td>
                 	<td>
                    	<input type="text" id="fm_sellingmoney" name="fm_sellingmoney" class="wid05" value=""> 만원/
                        <input type="text" id="fm_sellingyear" name="fm_sellingyear" class="wid03" value=""> 년
                    </td>
                 </tr>
                 <tr>
                 	<th><label for="fm_comtype">기업 형태</label></th>
                    <td colspan="5">
                    	<select class="wid07" name="fm_comtype" id="fm_comtype">
	            ...
	            <tr>
	            	<th>사업자등록증</th>
	                <td colspan="5">
						<input type="file" id="fm_file3" name="fm_file3" class="wid">
	             	</td>
	            </tr>
            </table>
</div>
