...
<option value='M060500' >대학원(박사)</option>
                        ...
                        <tr>
                        	<th scope="row" colspan="2"  class="ac"><span class="txt_or">*</span> 인원</th>
                            <td colspan="2">
...
<option value="20">20 년차</option>
            ...
            <!-- //tb_box : e -->
            <div class="btn_box">
            <input class="btn btn-lg btn-default js-disable-on-click" autocomplete="off" data-loading-text="저장 중" name="save_for_later" value="수정 요청" type="submit">
           </div>
        </div>
</form>
    </div>
