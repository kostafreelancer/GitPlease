              ...
              <div class="p5-serviceIntroduction-list">
                 <div class="p5-serviceIntroduction-list-component-right">
                   ...
                   <div class="p5-serviceIntroduction-list-text">
                     ...
                     <h5 class="p5-serviceIntroduction-list-title">"프로젝트 등록 후 6시간만에 11명의 지원자가! 그 속도에 놀랐다."</h5>
                     <p>- 스타트업 전문 미디어<b> beSUCCESS </b>남광식 에디터
                     </p>
                     </div>
                   </div>
                 </div>
                 ...
                 <div class="p5-serviceIntroduction-list-component-right">
                   ...
                   <div class="p5-serviceIntroduction-list-text">
                     <div class="p5-serviceIntroduction-list-text-wrapper">
                     <h5 class="p5-serviceIntroduction-list-title">"지원자들을 한 눈에 비교할 수 있어 선택이 용이했다.<br>일정 조율 및 서류작업을 대행해줘 프로젝트가 수월하게 진행됐다."
                     </h5>
                     <p> - 신개념 맞춤 여행사<b> 마이이리얼트립 </b>박성준 대표
                     </p>
                     </div>
                   </div>
                 </div>
