...
<link rel="stylesheet" href="e_projectInfo.css" type="text/css" media="screen" />

<link rel="stylesheet" href="../common/header.css" type="text/css" media="screen" />
<link rel="stylesheet" href="../common/footer.css" type="text/css" media="screen" />
<link rel="stylesheet" href="e_leftmenu.css" type="text/css" media="screen" />
<link rel="stylesheet" href="memberlist.css" type="text/css" media="screen" />
...
11.장비지참여부:
            ...
            <!-- //tb_box : e -->
            <div class="btn_box">
            <input class="btn btn-lg btn-default js-disable-on-click" autocomplete="off" data-loading-text="저장 중" name="save_for_later" value="수정하기" type="submit">
           </div>
        </div>
	                ...
	                <table class="tb_st01 tb_st03">
	                    ...
	                    <tbody>
							<tr>
								...
								<td class="ac">2017-4-26</td>
								<td class="ac">
									<a href="#" class="accept">수락</a>
									<a href="#" class="deny">거절</a>
								</td>
							</tr>
							<tr>
