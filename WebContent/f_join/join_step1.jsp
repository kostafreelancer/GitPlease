        ...
        프로필 및 기술 홍보 공간 제공
                        ...
                        <li>
                            ...
                            <p class="mb10">
                                ...
                                맞춤형 정규직 채용 지원<br />
                                IT 전문 정보 제공 <br />
                                프로필 및 기술 홍보 공간 제공<br />
                                메인 배너 공간에 홍보할 기회 제공<br />
                            </p>
                            <p>
                                <strong>* 재택 프로젝트 무한 입찰</strong><br />
                                <strong>* 1:1 세무/노무 상담</strong>
                            </p>
                        </li>
                    </ul>
                    <div class="btn_box02">
                ...
                <div class="elan_box01 elan_box02 elan_box_lef">
                    ...
                    <div class="btn_box02 btn_box02_lef">
                        <a href="javascript:MemberJoinIt('이랜서','팀');" class="btn_join02">기 업</a>
                    </div>
                </div>
                <!-- //elan_box : e -->
            </div>
