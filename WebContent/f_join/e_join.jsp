...
<link rel="stylesheet" href="f_join.css" type="text/css" media="screen" />
		...
		showItems: 1
			...
			<ul class="step_cont03">
                ...
                <table class="tb_st01">
					<form name="MemberWriteFm" method="post" action="member_write.php">
						...
						<input type="hidden" name="strPageCode1" value="ZXdMZjhRelA5Z1FXbTJWZ0Zpa0R2SzRMSWU=">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan="3">
                               <input type="text" id="fm_id" name="fm_id" class="" />
            ...
            <div class="tb_box">
                ...
                <table class="tb_st01">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row"><label for="fm_name"><span class="txt_or">*</span> 가입자명</label></th>
                            <td colspan="3">
                            	<input type="text" id="fm_name" name="fm_name"  class="wid04" />
                            </td>
                        </tr>
                         <tr>
                            <th scope="row"><label for="fm_comname"><span class="txt_or">*</span> 회사명</label></th>
                            <td colspan="3">
                            	<input type="text" id="fm_comname" name="fm_comname"  class="wid" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="fm_ceoname"><span class="txt_or">*</span> 대표자명</label></th>
                            <td>
                            	<input type="text" id="fm_ceoname" name="fm_ceoname"  class="wid" />
                            </td>
                            <th scope="row"><span class="txt_or">*</span> 사업자 등록번호</th>
                            <td>
                            	<label for="fm_comssn1"></label>
                            	<input type="text" id="fm_comssn1" name="fm_comssn1"  class="wid03" maxlength="3"/>
                                -
                                <label for="fm_comssn2"></label>
                            	<input type="text" id="fm_comssn2" name="fm_comssn2"  class="wid03" maxlength="2"/>
                                -
                                <label for=""></label>
                            	<input type="text" id="fm_comssn3" name="fm_comssn3"  class="wid03" maxlength="5"/>
                            </td>
                        </tr>
                         <tr>
                            <th scope="row"><label for="fm_bizcontents"><span class="txt_or">*</span> 주요사업내용</label></th>
                            <td colspan="3">
                            	<input type="text" id="fm_bizcontents" name="fm_bizcontents"  class="wid"/>
                            </td>
                        </tr>
                        <tr>
                        	<th scope="row"><label for="fm_managername"><span class="txt_or">*</span> 담당자명</label></th>
                            <td>
                            	<input type="text" id="fm_managername" name="fm_managername"  class="wid04"/>
                            </td>
                            <th scope="row"><label for="fm_phone1"><span class="txt_or">*</span> 담당자 연락처</label></th>
                            <td>
                            	  <label for="fm_phone1"></label>
                                    ...
                                    <span>-</span>
                                    <label for=""></label>
                                    <input type="text" id="fm_phone2" name="fm_phone2" class="wid03" maxlength="4">
                                    <span>-</span>
                                    <label for=""></label>
                                    <input type="text" id="fm_phone3" name="fm_phone3" class="wid03" maxlength="4">
                            </td>
                        </tr>
                         <tr>
                            <th scope="row"><label for="fm_tel1"><span class="txt_or">*</span> 연락처(대표전화)</label></th>
                            <td colspan="3">
                            	  <label for="fm_tel1"></label>
                                    ...
                                    <input type="text" id="fm_tel2" name="fm_tel2" class="wid03" maxlength="4">
                                    <span>-</span>
                                    <label for="fm_tel3"></label>
                                    <input type="text" id="fm_tel3" name="fm_tel3" class="wid03" maxlength="4">
                            </td>
                        </tr> 
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <input type="text" id="fm_email11" name="fm_email11" class="wid04">
                                <span>@</span>
                                <label for="fm_email12"></label>
                                <input type="text" id="fm_email12" name="fm_email12" class="wid04">
                         ...
                         <tr>
                            ...
                            <td colspan="3">
                            	<div class="mb10">
                                    ...
                                    <input type="text" id="fm_zip" name="fm_zip" class="wid60" onclick="openDaumPostCode(); return false;" readonly>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div>
                                	<span>http://</span>
                                    <input type="text" id="fm_homepage" name="fm_homepage" class="wid06">
                                </div>
                            </td>
                        </tr>
                        <tr>
