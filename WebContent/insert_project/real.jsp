...
<div class="market">
            ...
            <!-- //market : e -->
       		<div class="table_tit">
            	<h3>프로젝트 등록의뢰</h3>
                <div class="fr">
                    <p><span class="txt_or">(*) </span>표시는 필수 입력사항입니다. <!--<a href="javascript:void(0);" class="btn_sam">샘플양식</a>--></p>
            	</div>
            </div>         
            <!-- table_tit : e -->
            <div class="tb_box">
            	...
            	<table class="tb_st01">
                    ...
                    <tbody>
                    	<tr>
                        	<th scope="row"><span class="txt_or">*</span><label for="fm_comname">회사명</label></th>
                            <td colspan="3">
                            	<input type="text" id="fm_comname" name="fm_comname"  class="wid" value="" />
                            </td>
                        </tr>
                    	<tr>
                        	<th scope="row"><span class="txt_or">*</span> <label for="fm_korname">담당자명</label></th>
                            <td colspan="3">
                            	<input type="text" id="fm_korname" name="fm_korname"  class="wid01" value="" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" id="fm_tel2" name="fm_tel2"  class="wid03" value="" maxlength="4"/>
                                <span>-</span>
                                <label for="fm_tel3"></label>
                                <input type="text" id="fm_tel3" name="fm_tel3"  class="wid03" value="" maxlength="4" />
                            </td>
                            ...
                            <td>
                                ...
                                <input type="text" id="fm_phone2" name="fm_phone2"  class="wid03" value="" maxlength="4" />
                                <span>-</span>
                                <label for="fm_phone3"></label>
                                <input type="text" id="fm_phone3" name="fm_phone3"  class="wid03" value="" maxlength="4" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <input type="text" id="fm_email11" name="fm_email11"  class="wid04" value=""/>
                                <span>@</span>
                                <label for="fm_email12"></label>
                                <input type="text" id="fm_email12" name="fm_email12"  class="wid04" value="" />
            ...
            <div class="tb_box">
            	...
            	<table class="tb_st01">
                    ...
                    <tbody>
                    	<tr>
                        	<th scope="row" colspan="2" class="ac"><span class="txt_or">*</span><label for="fm_name">프로젝트 명</label></th>
                            <td colspan="5">
                            	<input type="text" id="fm_name" name="fm_name"  class="wid"/>
                            </td>
                        </tr>
                    	<tr>
						...
						<table width="100%">
							<colgroup>
									...
									<col width="20%"/>
													...
													<tr class="che_list011">
													<td class="td_bor_bott"><input type="checkbox" name="fm_new_keyword[]" value="DB" > DB</td>
													...
													<td class="td_bor_bott"><input type="checkbox" name="fm_new_keyword[]" value="JAVA" > JAVA</td>
													</tr>
													<tr class="che_list011">
                        ...
                        <tr>
                        	<th scope="row" colspan="2" class="ac"><span class="txt_or">*</span><label for="fm_content">상세내용</label></th>
                            <td colspan="5">
                            	<textarea id="fm_content" name="fm_content"  class="txt_area">
1.프로젝트명:
...
11.장비지참여부:
                        ...
                        <tr>
                        	<th scope="row" colspan="2"  class="ac"><span class="txt_or">*</span> 연령</th>
                            <td colspan="2">
                            	<select class="wid03" name="fm_fromAge" id="fm_fromAge">
...
<option value='1968' >50세(1968년생)</option>
                                ...
                                <span>~</span>
                                <select class="wid03" name="fm_toAge" id="fm_toAge">
									<option value=''>선택</option>
<option value='0000'>연령무관</option>
<option value='1998' >20세(1998년생)</option>
<option value='1997' >21세(1997년생)</option>
...
<option value='1968' >50세(1968년생)</option>
                            ...
                            <td colspan="2">
                            	<select class="wid04" name="fm_school" id="fm_school">
									<option value=''>선택</option>
...
<option value='M060500' >대학원(박사)</option>
                        ...
                        <tr>
                        	<th scope="row" colspan="2"  class="ac"><span class="txt_or">*</span> 모집인원</th>
                            <td colspan="2">
                            	<input type="text" id="fm_number" name="fm_number"  class="wid05" />
                                <label for="fm_number">명</label>
                            	(전체 참여인원 :
                                <input type="text" id="fm_totalnumber" name="fm_totalnumber" class="wid05" />
                                <label for="fm_totalnumber">명)</label>
                            </td>
                            <th scope="row"  class="ac"><span class="txt_or">*</span> <label for="fm_bidedate">모집마감일자</label></th>
                            <td colspan="2">
                            	<input type="text" id="fm_bidedate" name="fm_bidedate"  class="day_inp" onClick="CalenderIt('ProjectWriteFm', 'fm_bidedate');" readonly/>
								<input type="hidden" name="fm_bidsdate" value="2017-04-25">
                            </td> 
                        </tr>
                         <tr>
                        	<th scope="row" colspan="2"  class="ac"><span class="txt_or">*</span>프로젝트 금액(월단위)</th>
                            <td colspan="5">
							<input type="radio" name="fm_moneytype" value="A"  checked>
                            	<label for="fm_minmoney"></label>
                            	<input type="text" id="fm_minmoney" name="fm_minmoney"  class="wid03" onKeyPress="javascript:CheckMoney('ProjectWriteFm','fm_minmoney');" onKeyUp="javascript:CheckMoney('ProjectWriteFm','fm_minmoney');" />
                                <span>원 ~ </span>
                    			<label for="fm_maxmoney"></label>
                                <input type="text" id="fm_maxmoney" name="fm_maxmoney" class="wid03" onKeyPress="javascript:CheckMoney('ProjectWriteFm','fm_maxmoney');" onKeyUp="javascript:CheckMoney('ProjectWriteFm','fm_maxmoney');" />
                                <span>원 &nbsp;</span>
									<input type="radio" name="fm_moneychk" value="Y" checked> 협의가능&nbsp;
									<input type="radio" name="fm_moneychk" value="N"> 협의불가
                                <span class="txt_red">* VAT별도 금액입니다.</span>
								<br /><input type="radio" name="fm_moneytype" value="B"  > <span class="txt_red" style="float:none;" >가격제안 요청</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="5">
        						<input type="text" id="fm_worksdate" name="fm_worksdate"  class="day_inp" onClick="CalenderIt('ProjectWriteFm', 'fm_worksdate');" readonly />
                                <span> ~ </span>
                                <input type="text" id="fm_workedate" name="fm_workedate"  class="day_inp" onClick="CalenderIt('ProjectWriteFm', 'fm_workedate');" readonly />
                            </td>
                        </tr>
               
                        <tr>
                        	<th scope="row" colspan="2"  class="ac"><span class="txt_or">*</span> 근무지</th>
                            <td colspan="5">
        						<select class="JobPlace" name="JobPlace1" id="JobPlace1">
           ...
           <option value="18">해외</option>
								 ...
								 <select id="sigungu" class="selecter-element" name="sigungu" onclick="progress_check()" required="required" tabindex="-1">
           <option value="">시, 군, 구</option>
           <!-- 시, 도 선택후 나옴  -->
           </select>
                        </tr>
                        <tr>
                        	<th scope="row" colspan="2"  class="ac"><span class="txt_or">*</span> 희망 경력년수</th>
                            <td colspan="5">
        						<select class="wid03" name="fm_career1" id="fm_career1">
...
<option value="20">20 년차</option>
                                ...
                                <span>~</span>
                                <select class="wid03" name="fm_career2">
									<option value="">------</option>
									<option value="01">1 년차</option>
<option value="02">2 년차</option>
<option value="03">3 년차</option>
...
<option value="20">20 년차</option>
            ...
            <!-- //tb_box : e -->
            <div class="btn_box">
            <input class="btn btn-lg btn-default js-disable-on-click" autocomplete="off" data-loading-text="저장 중" name="save_for_later" value="임시 저장" type="submit">
            <input class="btn btn-lg btn-client js-disable-on-click btn-submit" autocomplete="off" data-loading-text="제출 중" name="post_a_job" value="프로젝트 정보 등록완료" type="submit">
